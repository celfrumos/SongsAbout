...
namespace SpotifyAPI.Web.Models
{
    ...
    //        this.Uri = artist.Uri;
    //    }
    //    public SpotifyArtist(BaseArtist artist) : this(Converter.GetFullArtist(artist))
    //    {
    ...
    //        }
    //    }
    //    public SpotifyAlbum(BaseAlbum album) : this(Converter.GetFullAlbum(album))
    //    {
    ...
    //        this.Uri = track.Uri;
    //    }
    //    public SpotifyTrack(BaseTrack track) : this(Converter.GetFullTrack(track))
    //    {
    ...
    //    }
    //}
    //public partial class SPlaylist : SpotifyAPI.Web.Models.BasePlaylist, ISpotifySimpleEntity
    //{
    //  public DbEntityType DbEntityType { get { return DbEntityType.Playlist; } }
    //    private BasePlaylist _base;
    //    public SPlaylist(BasePlaylist playlist)
    //    {
    //        this._base = playlist;
    //        this.Collaborative = playlist.Collaborative;
    //        this.ExternalUrls = playlist.ExternalUrls;
    ...
    //    }
    //    public static SPlaylist Convert(BasePlaylist playlist)
    //    {
    ...
    public interface ISpotifyImageList
    {
        List<SpotifyImage> Images { get; set; }

    }
    public interface ISpotifyFullEntity : ISpotifyEntity, ISpotifyImageList
    {
