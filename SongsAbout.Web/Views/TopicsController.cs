...
namespace SongsAbout.Web.Views
{
    public class TopicsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "TopicId,TopicText")] Topic topic)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "TopicId,TopicText")] Topic topic)
        {
            if (ModelState.IsValid)
            {
