...
namespace SongsAbout.Web.Models
{
    public class EntityDbInitializer : DropCreateDatabaseAlways<EntityDbContext>
    {
        protected override void Seed(EntityDbContext context)
        {
            ...
            context.Tracks.Add(new Track { TrackId = 0, ArtistId = 0, AlbumId = 0, Name = "The Book Of Love", SpotifyId = "25tMQOrIU4LlUo6Sv8v5SE" });
            context.Tracks.Add(new Track { TrackId = 1, ArtistId = 1, AlbumId = 1, Name = "Tomorrow Never Comes - (Acoustic Version)", SpotifyId = "6yJCxee7QumYr820xdIsjo" });
            context.Tracks.Add(new Track { TrackId = 2, ArtistId = 2, AlbumId = 2, Name = "The Temptation of Adam", SpotifyId = "6igfLpd8s6DBBAuwebRUuo" });
            context.Tracks.Add(new Track { TrackId = 3, ArtistId = 3, AlbumId = 3, Name = "I Don't Want To Change You", SpotifyId = "14r9dR01KeBLFfylVSKCZQ" });
            context.Tracks.Add(new Track { TrackId = 4, ArtistId = 4, AlbumId = 4, Name = "Above The Clouds Of Pompeii", SpotifyId = "0nJaMZM8paoA5HEUTUXPqi" });
            context.Tracks.Add(new Track { TrackId = 5, ArtistId = 5, AlbumId = 5, Name = "The Way That I Need You", SpotifyId = "0gadJ2b9A4SKsB1RFkBb66" });
            context.Tracks.Add(new Track { TrackId = 7, ArtistId = 7, AlbumId = 7, Name = "Jolene", SpotifyId = "6DoH7ywD5BcQvjloe9OcIj" });
            context.Tracks.Add(new Track { TrackId = 8, ArtistId = 8, AlbumId = 8, Name = "Mercy", SpotifyId = "12Chz98pHFMPJEknJQMWvI" });
            context.Tracks.Add(new Track { TrackId = 9, ArtistId = 9, AlbumId = 9, Name = "I Don't Mind", SpotifyId = "1L3hqVCHSL1Ajy3m0z1bAT" });
            context.Tracks.Add(new Track { TrackId = 10, ArtistId = 10, AlbumId = 10, Name = "I Just Wanna Run", SpotifyId = "7MRDkEKtdsGcYn11A4qgUL" });
            context.Tracks.Add(new Track { TrackId = 11, ArtistId = 5, AlbumId = 11, Name = "Coins in a Fountain", SpotifyId = "0gadJ2b9A4SKsB1RFkBb66" });
            context.Tracks.Add(new Track { TrackId = 12, ArtistId = 12, AlbumId = 12, Name = "Old Pine", SpotifyId = "5schNIzWdI9gJ1QRK8SBnc" });
            context.Tracks.Add(new Track { TrackId = 14, ArtistId = 14, AlbumId = 14, Name = "Skinny Love", SpotifyId = "4LEiUm1SRbFMgfqnQTwUbQ" });
            context.Tracks.Add(new Track { TrackId = 15, ArtistId = 15, AlbumId = 15, Name = "I See Fire", SpotifyId = "6eUKZXaKkcviH0Ku9w2n3V" });
            context.Tracks.Add(new Track { TrackId = 16, ArtistId = 16, AlbumId = 16, Name = "Higher Love", SpotifyId = "7FDlvgcodNfC0IBdWevl4u" });
            context.Tracks.Add(new Track { TrackId = 18, ArtistId = 18, AlbumId = 18, Name = "Thirteen Sad Farewells", SpotifyId = "44M8i4BCwuBbmcQWwMaOfH" });
            context.Tracks.Add(new Track { TrackId = 19, ArtistId = 19, AlbumId = 19, Name = "Barton Hollow", SpotifyId = "6J7rw7NELJUCThPbAfyLIE" });
            context.Tracks.Add(new Track { TrackId = 21, ArtistId = 21, AlbumId = 21, Name = "Take Me to Church", SpotifyId = "2FXC3k01G6Gw61bmprjgqS" });
            context.Tracks.Add(new Track { TrackId = 22, ArtistId = 22, AlbumId = 22, Name = "The Reason", SpotifyId = "2MqhkhX4npxDZ62ObR5ELO" });
            context.Tracks.Add(new Track { TrackId = 23, ArtistId = 8, AlbumId = 23, Name = "Dead Inside", SpotifyId = "12Chz98pHFMPJEknJQMWvI" });
            context.Tracks.Add(new Track { TrackId = 24, ArtistId = 24, AlbumId = 24, Name = "Brick", SpotifyId = "44gRHbEm4Uqa0ykW0rDTNk" });
            context.Tracks.Add(new Track { TrackId = 25, ArtistId = 25, AlbumId = 25, Name = "The Freshmen", SpotifyId = "242iqFnwNhlidVBMI9GYKp" });
            context.Tracks.Add(new Track { TrackId = 26, ArtistId = 26, AlbumId = 26, Name = "Landslide", SpotifyId = "40Yq4vzPs9VNUrIBG5Jr2i" });
            context.Tracks.Add(new Track { TrackId = 27, ArtistId = 27, AlbumId = 27, Name = "Californication", SpotifyId = "0L8ExT028jH3ddEcZwqJJ5" });
            context.Tracks.Add(new Track { TrackId = 28, ArtistId = 28, AlbumId = 28, Name = "Swing Life Away", SpotifyId = "6Wr3hh341P84m3EI8qdn9O" });
            context.Tracks.Add(new Track { TrackId = 29, ArtistId = 29, AlbumId = 29, Name = "Electric Love", SpotifyId = "1KP6TWI40m7p3QBTU6u2xo" });
            context.Tracks.Add(new Track { TrackId = 30, ArtistId = 30, AlbumId = 30, Name = "Silent Lucidity", SpotifyId = "2OgUPVlWYgGBGMefZgGvCO" });
            context.Tracks.Add(new Track { TrackId = 31, ArtistId = 31, AlbumId = 31, Name = "Superman (It's Not Easy) - New Album Version", SpotifyId = "7FgMLbnZVrEnir95O0YujA" });
            context.Tracks.Add(new Track { TrackId = 32, ArtistId = 32, AlbumId = 32, Name = "King", SpotifyId = "5vBSrE1xujD2FXYRarbAXc" });
            context.Tracks.Add(new Track { TrackId = 34, ArtistId = 34, AlbumId = 34, Name = "My Girl", SpotifyId = "3RwQ26hR2tJtA8F9p2n7jG" });
            context.Tracks.Add(new Track { TrackId = 35, ArtistId = 32, AlbumId = 35, Name = "Take Shelter", SpotifyId = "5vBSrE1xujD2FXYRarbAXc" });
            context.Tracks.Add(new Track { TrackId = 36, ArtistId = 15, AlbumId = 15, Name = "Tenerife Sea", SpotifyId = "6eUKZXaKkcviH0Ku9w2n3V" });
            context.Tracks.Add(new Track { TrackId = 37, ArtistId = 15, AlbumId = 37, Name = "U.N.I.", SpotifyId = "6eUKZXaKkcviH0Ku9w2n3V" });
            context.Tracks.Add(new Track { TrackId = 38, ArtistId = 15, AlbumId = 37, Name = "Autumn Leaves - Deluxe Edition", SpotifyId = "6eUKZXaKkcviH0Ku9w2n3V" });
            context.Tracks.Add(new Track { TrackId = 39, ArtistId = 15, AlbumId = 37, Name = "Lego House", SpotifyId = "6eUKZXaKkcviH0Ku9w2n3V" });
            context.Tracks.Add(new Track { TrackId = 40, ArtistId = 5, AlbumId = 5, Name = "Travelling Alone", SpotifyId = "0gadJ2b9A4SKsB1RFkBb66" });
            context.Tracks.Add(new Track { TrackId = 41, ArtistId = 5, AlbumId = 5, Name = "David", SpotifyId = "0gadJ2b9A4SKsB1RFkBb66" });
            context.Tracks.Add(new Track { TrackId = 42, ArtistId = 5, AlbumId = 11, Name = "Heart's On Fire - Acoustic", SpotifyId = "0gadJ2b9A4SKsB1RFkBb66" });
            context.Tracks.Add(new Track { TrackId = 43, ArtistId = 4, AlbumId = 43, Name = "Sophie", SpotifyId = "0nJaMZM8paoA5HEUTUXPqi" });
            context.Tracks.Add(new Track { TrackId = 45, ArtistId = 45, AlbumId = 45, Name = "Comeback Kid (That's My Dog)", SpotifyId = "0FC1LIeQXKib0jOwZqeIwT" });
            context.Tracks.Add(new Track { TrackId = 50, ArtistId = 50, AlbumId = 50, Name = "Veterans Day", SpotifyId = "6vMmqaauubP4qBujCf6DPY" });
            context.Tracks.Add(new Track { TrackId = 51, ArtistId = 50, AlbumId = 50, Name = "Personal Rockstar", SpotifyId = "6vMmqaauubP4qBujCf6DPY" });
            context.Tracks.Add(new Track { TrackId = 52, ArtistId = 52, AlbumId = 52, Name = "I Don't Want To Go Home", SpotifyId = "3x8FbPjh2Qz55XMdE2Yalj" });
            context.Tracks.Add(new Track { TrackId = 53, ArtistId = 53, AlbumId = 53, Name = "Creep - Acoustic", SpotifyId = "4Z8W4fKeB5YxbusRsdQVPb" });
            context.Tracks.Add(new Track { TrackId = 54, ArtistId = 18, AlbumId = 18, Name = "San Francisco", SpotifyId = "44M8i4BCwuBbmcQWwMaOfH" });
            context.Tracks.Add(new Track { TrackId = 55, ArtistId = 55, AlbumId = 55, Name = "For the Widows in Paradise, For the Fatherless in Ypsilanti", SpotifyId = "4MXUO7sVCaFgFjoTI5ox5c" });
            context.Tracks.Add(new Track { TrackId = 56, ArtistId = 55, AlbumId = 56, Name = "To Be Alone With You", SpotifyId = "4MXUO7sVCaFgFjoTI5ox5c" });
            context.Tracks.Add(new Track { TrackId = 57, ArtistId = 57, AlbumId = 57, Name = "The Ballad Of Love And Hate", SpotifyId = "196lKsA13K3keVXMDFK66q" });
            context.Tracks.Add(new Track { TrackId = 58, ArtistId = 57, AlbumId = 58, Name = "Murder in the City", SpotifyId = "196lKsA13K3keVXMDFK66q" });
            context.Tracks.Add(new Track { TrackId = 59, ArtistId = 59, AlbumId = 59, Name = "Wasn't Expecting That", SpotifyId = "1jhdZdzOd4TJLAHqQdkUND" });
            context.Tracks.Add(new Track { TrackId = 60, ArtistId = 60, AlbumId = 60, Name = "Resolution", SpotifyId = "7CIW23FQUXPc1zebnO1TDG" });
            context.Tracks.Add(new Track { TrackId = 61, ArtistId = 60, AlbumId = 61, Name = "Untitled", SpotifyId = "7CIW23FQUXPc1zebnO1TDG" });
            context.Tracks.Add(new Track { TrackId = 62, ArtistId = 60, AlbumId = 61, Name = "Brother", SpotifyId = "7CIW23FQUXPc1zebnO1TDG" });
            context.Tracks.Add(new Track { TrackId = 63, ArtistId = 63, AlbumId = 63, Name = "Beautiful", SpotifyId = "5XVcYaeSTGZXwxd63aY9Tv" });
            context.Tracks.Add(new Track { TrackId = 64, ArtistId = 64, AlbumId = 64, Name = "Chasing Rubies - Acoustic", SpotifyId = "4DX2G1URzfEiRg2wBfv4ub" });
            context.Tracks.Add(new Track { TrackId = 65, ArtistId = 65, AlbumId = 65, Name = "Brooklyn Raining", SpotifyId = "1f2CFEq5J7ZyeTAVU6ubRX" });
            context.Tracks.Add(new Track { TrackId = 66, ArtistId = 66, AlbumId = 66, Name = "Crossfire", SpotifyId = "18Zv2g2vUcEGqJf6WnjfXN" });
            context.Tracks.Add(new Track { TrackId = 67, ArtistId = 67, AlbumId = 67, Name = "Chains", SpotifyId = "4Rxn7Im3LGfyRkY2FlHhWi" });
            context.Tracks.Add(new Track { TrackId = 68, ArtistId = 67, AlbumId = 68, Name = "Jealous", SpotifyId = "4Rxn7Im3LGfyRkY2FlHhWi" });
            context.Tracks.Add(new Track { TrackId = 69, ArtistId = 69, AlbumId = 69, Name = "Say Something", SpotifyId = "5xKp3UyavIBUsGy3DQdXeF" });
            context.Tracks.Add(new Track { TrackId = 70, ArtistId = 70, AlbumId = 70, Name = "Brothers", SpotifyId = "65o6y7GtoXzchyiJB3r9Ur" });
            context.Tracks.Add(new Track { TrackId = 71, ArtistId = 71, AlbumId = 71, Name = "If It Don't Work Out", SpotifyId = "1oplL2hHYq7CQykvSbd6gy" });
            context.Tracks.Add(new Track { TrackId = 72, ArtistId = 72, AlbumId = 72, Name = "Falling in Love at a Coffee Shop", SpotifyId = "1whjlG0NSaQytgDIWz10GS" });
            context.Tracks.Add(new Track { TrackId = 73, ArtistId = 73, AlbumId = 73, Name = "Do Not Let Me Go", SpotifyId = "1I7oHjCjMrMUz66v67yJJu" });
            context.Tracks.Add(new Track { TrackId = 74, ArtistId = 74, AlbumId = 74, Name = "New York", SpotifyId = "7DEseTqRODmSu3C7jxCHl5" });
            context.Tracks.Add(new Track { TrackId = 75, ArtistId = 75, AlbumId = 75, Name = "The Permanent Rain", SpotifyId = "0iMnpaEHXkgMT956CmP1kj" });
            context.Tracks.Add(new Track { TrackId = 76, ArtistId = 76, AlbumId = 76, Name = "Mr. Brightside", SpotifyId = "0C0XlULifJtAgn6ZNCW2eu" });
            context.Tracks.Add(new Track { TrackId = 77, ArtistId = 76, AlbumId = 76, Name = "Somebody Told Me", SpotifyId = "0C0XlULifJtAgn6ZNCW2eu" });
            context.Tracks.Add(new Track { TrackId = 78, ArtistId = 76, AlbumId = 78, Name = "When You Were Young", SpotifyId = "0C0XlULifJtAgn6ZNCW2eu" });
            context.Tracks.Add(new Track { TrackId = 79, ArtistId = 76, AlbumId = 76, Name = "All These Things That I've Done", SpotifyId = "0C0XlULifJtAgn6ZNCW2eu" });
            context.Tracks.Add(new Track { TrackId = 80, ArtistId = 76, AlbumId = 80, Name = "Human", SpotifyId = "0C0XlULifJtAgn6ZNCW2eu" });
            context.Tracks.Add(new Track { TrackId = 81, ArtistId = 81, AlbumId = 81, Name = "The Sound Of Silence", SpotifyId = "3TOqt5oJwL9BE2NG9MEwDa" });
            context.Tracks.Add(new Track { TrackId = 82, ArtistId = 82, AlbumId = 82, Name = "Back To You", SpotifyId = "6GwNGuDRNbx5XwoHQA3QiD" });
            context.Tracks.Add(new Track { TrackId = 83, ArtistId = 83, AlbumId = 83, Name = "Let It Go", SpotifyId = "4EzkuveR9pLvDVFNx6foYD" });
            context.Tracks.Add(new Track { TrackId = 84, ArtistId = 84, AlbumId = 84, Name = "Lost Tonight", SpotifyId = "0F55dmw0A9gnYhgJfH0b3b" });
            context.Tracks.Add(new Track { TrackId = 85, ArtistId = 32, AlbumId = 35, Name = "King - Acoustic", SpotifyId = "5vBSrE1xujD2FXYRarbAXc" });
            context.Tracks.Add(new Track { TrackId = 86, ArtistId = 86, AlbumId = 86, Name = "Run Every Time", SpotifyId = "5DYAABs8rkY9VhwtENoQCz" });
            context.Tracks.Add(new Track { TrackId = 88, ArtistId = 88, AlbumId = 88, Name = "You're Not Alone", SpotifyId = "1NUOfvAhA9AvsF1ISMkgHX" });
            context.Tracks.Add(new Track { TrackId = 89, ArtistId = 89, AlbumId = 89, Name = "The Rules for Lovers", SpotifyId = "3rUqgY188kWz0hKkqnpk9F" });
            context.Tracks.Add(new Track { TrackId = 90, ArtistId = 90, AlbumId = 90, Name = "Storybook", SpotifyId = "405DvLr0FOuOWYgCt0emff" });
            context.Tracks.Add(new Track { TrackId = 91, ArtistId = 91, AlbumId = 91, Name = "Love During Wartime", SpotifyId = "2knI8PaBy2UyrRBhGmBbQJ" });
            context.Tracks.Add(new Track { TrackId = 92, ArtistId = 92, AlbumId = 92, Name = "Lovers Without Love", SpotifyId = "0YLUOdFiedWIWBttlDAQeO" });
            context.Tracks.Add(new Track { TrackId = 93, ArtistId = 93, AlbumId = 93, Name = "I'd Sing Hallelujah", SpotifyId = "5gj2Ul170gSipbsNQbea37" });
            context.Tracks.Add(new Track { TrackId = 94, ArtistId = 94, AlbumId = 94, Name = "Song For Zula - Live at St. Pancras Church", SpotifyId = "57kIMCLPgkzQlXjblX7XXP" });
            context.Tracks.Add(new Track { TrackId = 95, ArtistId = 95, AlbumId = 95, Name = "Moondust (Stripped)", SpotifyId = "6QrQ7OrISRYIfS5mtacaw2" });
            context.Tracks.Add(new Track { TrackId = 96, ArtistId = 96, AlbumId = 96, Name = "If I Tremble", SpotifyId = "4UXiNDHAiv8DOSLkp0GbSm" });
            context.Tracks.Add(new Track { TrackId = 97, ArtistId = 97, AlbumId = 97, Name = "Home From Home", SpotifyId = "0XHM5ZNJDU8e4CfbWMeSzC" });
            context.Tracks.Add(new Track { TrackId = 98, ArtistId = 98, AlbumId = 98, Name = "Thank You", SpotifyId = "6AlXfeCNG9lrauBDG7GyjM" });
            context.Tracks.Add(new Track { TrackId = 99, ArtistId = 96, AlbumId = 96, Name = "Island of the Misfit Boy", SpotifyId = "4UXiNDHAiv8DOSLkp0GbSm" });
