...
namespace SongsAbout.Web.Models
{
    public class EntityDbInitializer : DropCreateDatabaseAlways<EntityDbContext>
    {
        protected override void Seed(EntityDbContext context)
        {
            ...
            //Albums
            context.Albums.Add(new Album { ArtistId = 0, Name = "The Book Of Love", SpotifyId = " 0N1btvaeNMojeaTbp5LQby", ReleaseDate = Convert.ToDateTime("3/6/2015 12:00:00 AM"), AlbumCoverId = 0 });
            context.Albums.Add(new Album { ArtistId = 1, Name = "JEKYLL + HYDE", SpotifyId = " 1xy141zMRluP7YaE94IawT", ReleaseDate = Convert.ToDateTime("4/28/2015 12:00:00 AM"), AlbumCoverId = 1 });
            context.Albums.Add(new Album { ArtistId = 2, Name = "The Historical Conquests of Josh Ritter", SpotifyId = " 40xscsIpyzlVZTBC5cDOFH", ReleaseDate = Convert.ToDateTime("8/21/2007 12:00:00 AM"), AlbumCoverId = 2 });
            context.Albums.Add(new Album { ArtistId = 3, Name = "I Don't Want To Change You", SpotifyId = " 5XjLh03TyuPPWZWMYQeExC", ReleaseDate = Convert.ToDateTime("9/24/2014 12:00:00 AM"), AlbumCoverId = 3 });
            context.Albums.Add(new Album { ArtistId = 4, Name = "Islands", SpotifyId = " 15z9H7eEOCtB2Xq28SDWwp", ReleaseDate = Convert.ToDateTime("10/21/2014 12:00:00 AM"), AlbumCoverId = 4 });
            context.Albums.Add(new Album { ArtistId = 5, Name = "Whispers II", SpotifyId = " 1tuA98Wr7drhpoaMqPIO5V", ReleaseDate = Convert.ToDateTime("4/20/2015 12:00:00 AM"), AlbumCoverId = 5 });
            context.Albums.Add(new Album { ArtistId = 6, Name = "Trouble", SpotifyId = " 2DQHgaOMVOs2OKLaksiMx9", ReleaseDate = Convert.ToDateTime("8/15/2004 12:00:00 AM"), AlbumCoverId = 7 });
            context.Albums.Add(new Album { ArtistId = 7, Name = "Drones", SpotifyId = " 2wart5Qjnvx1fd7LPdQxgJ", ReleaseDate = Convert.ToDateTime("6/4/2015 12:00:00 AM"), AlbumCoverId = 8 });
            context.Albums.Add(new Album { ArtistId = 8, Name = "Empty Days & Sleepless Nights", SpotifyId = " 21VSN8gsYIiT4XajInScc1", ReleaseDate = Convert.ToDateTime("3/8/2011 12:00:00 AM"), AlbumCoverId = 9 });
            context.Albums.Add(new Album { ArtistId = 9, Name = "Best I Never Had", SpotifyId = " 5fXNchpJ8jblaAsFQgVjLH", ReleaseDate = Convert.ToDateTime("3/23/2010 12:00:00 AM"), AlbumCoverId = 10 });
            context.Albums.Add(new Album { ArtistId = 5, Name = "Whispers (Deluxe)", SpotifyId = " 3WvSr7uc2MOaNgWDxNxLqJ", ReleaseDate = Convert.ToDateTime("6/6/2014 12:00:00 AM"), AlbumCoverId = 11 });
            context.Albums.Add(new Album { ArtistId = 10, Name = "Every Kingdom (Deluxe Version)", SpotifyId = " 2MxcbOGFi99D9JACvj74AH", ReleaseDate = Convert.ToDateTime("1/1/2011 12:00:00 AM"), AlbumCoverId = 12 });
            context.Albums.Add(new Album { ArtistId = 11, Name = "For Emma, Forever Ago", SpotifyId = " 2wBGb1zLSWrmiOdinWE831", ReleaseDate = Convert.ToDateTime("7/8/2007 12:00:00 AM"), AlbumCoverId = 14 });
            context.Albums.Add(new Album { ArtistId = 12, Name = "x (Deluxe Edition)", SpotifyId = " 1xn54DMo2qIqBuMqHtUsFd", ReleaseDate = Convert.ToDateTime("6/21/2014 12:00:00 AM"), AlbumCoverId = 15 });
            context.Albums.Add(new Album { ArtistId = 13, Name = "Silver Lining", SpotifyId = " 5U017xFzIEof40cTb7Z1SF", ReleaseDate = Convert.ToDateTime("5/20/2011 12:00:00 AM"), AlbumCoverId = 16 });
            context.Albums.Add(new Album { ArtistId = 14, Name = "Vagabond", SpotifyId = " 0wnmzxrNPbDrffxcDs2yII", ReleaseDate = Convert.ToDateTime("7/11/2014 12:00:00 AM"), AlbumCoverId = 18 });
            context.Albums.Add(new Album { ArtistId = 15, Name = "Barton Hollow", SpotifyId = " 3GtyVMEnfmc3rl8pTYBJqi", ReleaseDate = Convert.ToDateTime("3/2/2012 12:00:00 AM"), AlbumCoverId = 19 });
            context.Albums.Add(new Album { ArtistId = 16, Name = "Hozier", SpotifyId = " 04E0aLUdCHnhnnYrDDvcHq", ReleaseDate = Convert.ToDateTime("10/7/2014 12:00:00 AM"), AlbumCoverId = 21 });
            context.Albums.Add(new Album { ArtistId = 17, Name = "Best Of", SpotifyId = " 6471rrLPKqZgXQ6TqN5AgU", ReleaseDate = Convert.ToDateTime("1/1/2010 12:00:00 AM"), AlbumCoverId = 22 });
            context.Albums.Add(new Album { ArtistId = 7, Name = "Dead Inside", SpotifyId = " 6p5gd9wYS8TAHQgc6HVuAf", ReleaseDate = Convert.ToDateTime("3/23/2015 12:00:00 AM"), AlbumCoverId = 23 });
            context.Albums.Add(new Album { ArtistId = 18, Name = "Whatever And Ever Amen (Remastered Edition)", SpotifyId = " 3oz8kworUyU7oXjaEVhDsZ", ReleaseDate = Convert.ToDateTime("2/10/1997 12:00:00 AM"), AlbumCoverId = 24 });
            context.Albums.Add(new Album { ArtistId = 19, Name = "Villains", SpotifyId = " 3sV3CL42DZ8C11MuQwVUEi", ReleaseDate = Convert.ToDateTime("3/25/1996 12:00:00 AM"), AlbumCoverId = 25 });
            context.Albums.Add(new Album { ArtistId = 20, Name = "Rotten Apples, The Smashing Pumpkins Greatest Hits", SpotifyId = " 1cUnNrx2TxvrpwPRtvpGwn", ReleaseDate = Convert.ToDateTime("11/20/2001 12:00:00 AM"), AlbumCoverId = 26 });
            context.Albums.Add(new Album { ArtistId = 21, Name = "Californication (Deluxe Version)", SpotifyId = " 2Y9IRtehByVkegoD7TcLfi", ReleaseDate = Convert.ToDateTime("6/8/1999 12:00:00 AM"), AlbumCoverId = 27 });
            context.Albums.Add(new Album { ArtistId = 22, Name = "Siren Song Of The Counter-Culture", SpotifyId = " 1vHYkIhnwbpzrC3hGguDN6", ReleaseDate = Convert.ToDateTime("1/1/2004 12:00:00 AM"), AlbumCoverId = 28 });
            context.Albums.Add(new Album { ArtistId = 23, Name = "Candy", SpotifyId = " 3QykM79uWpxMEc3e29D711", ReleaseDate = Convert.ToDateTime("11/10/2014 12:00:00 AM"), AlbumCoverId = 29 });
            context.Albums.Add(new Album { ArtistId = 24, Name = "The Best Of Queensryche (Deluxe Edition)", SpotifyId = " 2aeeuAwAoszbv0YkEscAFx", ReleaseDate = Convert.ToDateTime("8/28/2007 12:00:00 AM"), AlbumCoverId = 30 });
            context.Albums.Add(new Album { ArtistId = 25, Name = "America Town", SpotifyId = " 5MqEXYwwyJYjOb3g7vJ9ZY", ReleaseDate = Convert.ToDateTime("9/26/2000 12:00:00 AM"), AlbumCoverId = 31 });
            context.Albums.Add(new Album { ArtistId = 26, Name = "Communion", SpotifyId = " 4UEwyWgDZ9V7WgNRqD0Etx", ReleaseDate = Convert.ToDateTime("7/10/2015 12:00:00 AM"), AlbumCoverId = 32 });
            context.Albums.Add(new Album { ArtistId = 27, Name = "An American Love Story", SpotifyId = " 0P2UzaCywB5aWhIplMUryK", ReleaseDate = Convert.ToDateTime("8/10/1999 12:00:00 AM"), AlbumCoverId = 34 });
            context.Albums.Add(new Album { ArtistId = 26, Name = "Communion (Deluxe)", SpotifyId = " 50jDQcZjE2kdx5rn3AL0c8", ReleaseDate = Convert.ToDateTime("7/10/2015 12:00:00 AM"), AlbumCoverId = 35 });
            context.Albums.Add(new Album { ArtistId = 12, Name = "+", SpotifyId = " 02pi98kE0nra0yBqCStzbC", ReleaseDate = Convert.ToDateTime("9/9/2011 12:00:00 AM"), AlbumCoverId = 37 });
            context.Albums.Add(new Album { ArtistId = 4, Name = "Without/Within", SpotifyId = " 5IbjvCuVMchAsoXKOvVrof", ReleaseDate = Convert.ToDateTime("10/28/2013 12:00:00 AM"), AlbumCoverId = 43 });
            context.Albums.Add(new Album { ArtistId = 28, Name = "The Definitive Collection", SpotifyId = " 7qF9HEA57AL9dPGlipcDvF", ReleaseDate = Convert.ToDateTime("1/29/2013 12:00:00 AM"), AlbumCoverId = 45 });
            context.Albums.Add(new Album { ArtistId = 29, Name = "In Retrospect", SpotifyId = " 3cFKgcv6a3IhNw7f4qfVrw", ReleaseDate = Convert.ToDateTime("5/5/2011 12:00:00 AM"), AlbumCoverId = 50 });
            context.Albums.Add(new Album { ArtistId = 30, Name = "First Mind", SpotifyId = " 0ntJpgznXrZ6Qc8wTxtcXh", ReleaseDate = Convert.ToDateTime("5/12/2014 12:00:00 AM"), AlbumCoverId = 52 });
            context.Albums.Add(new Album { ArtistId = 31, Name = "Pablo Honey [Collector's Edition]", SpotifyId = " 6AZv3m27uyRxi8KyJSfUxL", ReleaseDate = Convert.ToDateTime("4/23/1993 12:00:00 AM"), AlbumCoverId = 53 });
            context.Albums.Add(new Album { ArtistId = 32, Name = "Michigan", SpotifyId = " 4mIfqTE8DOnFRFWUQH02Og", ReleaseDate = Convert.ToDateTime("7/1/2003 12:00:00 AM"), AlbumCoverId = 55 });
            context.Albums.Add(new Album { ArtistId = 32, Name = "Seven Swans", SpotifyId = " 71M94qZwSYHxlae0EFxpsy", ReleaseDate = Convert.ToDateTime("3/16/2004 12:00:00 AM"), AlbumCoverId = 56 });
            context.Albums.Add(new Album { ArtistId = 33, Name = "Emotionalism", SpotifyId = " 2ktxUTtc7FIpTH3vN70NZm", ReleaseDate = Convert.ToDateTime("5/15/2007 12:00:00 AM"), AlbumCoverId = 57 });
            context.Albums.Add(new Album { ArtistId = 33, Name = "The Second Gleam", SpotifyId = " 12Rp5bkZ5iX3URHnhaV3fy", ReleaseDate = Convert.ToDateTime("7/22/2008 12:00:00 AM"), AlbumCoverId = 58 });
            context.Albums.Add(new Album { ArtistId = 34, Name = "Jamie Lawson", SpotifyId = " 7qrYgKHSH8bIE5gSqXD5pR", ReleaseDate = Convert.ToDateTime("10/16/2015 12:00:00 AM"), AlbumCoverId = 59 });
            context.Albums.Add(new Album { ArtistId = 35, Name = "Resolution", SpotifyId = " 4tdzAgo7pkWfip1jSWtXZ8", ReleaseDate = Convert.ToDateTime("7/10/2013 12:00:00 AM"), AlbumCoverId = 60 });
            context.Albums.Add(new Album { ArtistId = 35, Name = "Into The Flame", SpotifyId = " 32TZZ9ZjC7EFFMYQxf3jYa", ReleaseDate = Convert.ToDateTime("11/16/2012 12:00:00 AM"), AlbumCoverId = 61 });
            context.Albums.Add(new Album { ArtistId = 36, Name = "Where We Land", SpotifyId = " 2TUwNtx2IHTlI893tFbuo1", ReleaseDate = Convert.ToDateTime("8/18/2007 12:00:00 AM"), AlbumCoverId = 63 });
            context.Albums.Add(new Album { ArtistId = 37, Name = "Chasing Rubies", SpotifyId = " 1PhDRrqg3pfj14hJ8YZjkX", ReleaseDate = Convert.ToDateTime("8/6/2013 12:00:00 AM"), AlbumCoverId = 64 });
            context.Albums.Add(new Album { ArtistId = 38, Name = "She Never Sleeps", SpotifyId = " 3Ii9Qw8DEJAT9lrFfHU0Lw", ReleaseDate = Convert.ToDateTime("9/6/2012 12:00:00 AM"), AlbumCoverId = 65 });
            context.Albums.Add(new Album { ArtistId = 39, Name = "Flamingo", SpotifyId = " 7zKxFkMyehmw9u3MhLpMPK", ReleaseDate = Convert.ToDateTime("1/1/2010 12:00:00 AM"), AlbumCoverId = 66 });
            context.Albums.Add(new Album { ArtistId = 40, Name = "Nick Jonas X2", SpotifyId = " 4G4Azv5cwPBv3vCA0mD6ei", ReleaseDate = Convert.ToDateTime("11/20/2015 12:00:00 AM"), AlbumCoverId = 67 });
            context.Albums.Add(new Album { ArtistId = 40, Name = "Jealous", SpotifyId = " 5nPBVVe9BU2LhAskz2mfv2", ReleaseDate = Convert.ToDateTime("9/8/2014 12:00:00 AM"), AlbumCoverId = 68 });
            context.Albums.Add(new Album { ArtistId = 41, Name = "Is There Anybody Out There?", SpotifyId = " 1yOcLa4euMk9sV7rRJ89Dl", ReleaseDate = Convert.ToDateTime("1/17/2014 12:00:00 AM"), AlbumCoverId = 69 });
            context.Albums.Add(new Album { ArtistId = 42, Name = "Tenboom", SpotifyId = " 2cVOSmXfC0wZBoj7TmpZl7", ReleaseDate = Convert.ToDateTime("1/8/2013 12:00:00 AM"), AlbumCoverId = 70 });
            context.Albums.Add(new Album { ArtistId = 43, Name = "The Shipwreck From The Shore", SpotifyId = " 2Qgr6jCKL8wNL2guAKcH5b", ReleaseDate = Convert.ToDateTime("9/2/2014 12:00:00 AM"), AlbumCoverId = 71 });
            context.Albums.Add(new Album { ArtistId = 44, Name = "The Boy Who Never", SpotifyId = " 1fFFfcxhKi0kSPhm8kdOuf", ReleaseDate = Convert.ToDateTime("9/24/2009 12:00:00 AM"), AlbumCoverId = 72 });
            context.Albums.Add(new Album { ArtistId = 45, Name = "Where the Mountain Meets the Valley", SpotifyId = " 5edOmr4NvYttuaSL8i2YbZ", ReleaseDate = Convert.ToDateTime("5/15/2012 12:00:00 AM"), AlbumCoverId = 73 });
            context.Albums.Add(new Album { ArtistId = 46, Name = "Promises", SpotifyId = " 3BknnUoNzGzkUQQUA78AfK", ReleaseDate = Convert.ToDateTime("5/10/2013 12:00:00 AM"), AlbumCoverId = 74 });
            context.Albums.Add(new Album { ArtistId = 47, Name = "Reach For The Sun", SpotifyId = " 13Zqbq7TFA0zOHrK4ZLO9J", ReleaseDate = Convert.ToDateTime("5/5/2009 12:00:00 AM"), AlbumCoverId = 75 });
            context.Albums.Add(new Album { ArtistId = 48, Name = "Hot Fuss", SpotifyId = " 4undIeGmofnAYKhnDclN1w", ReleaseDate = Convert.ToDateTime("1/1/2004 12:00:00 AM"), AlbumCoverId = 76 });
            context.Albums.Add(new Album { ArtistId = 48, Name = "Sam's Town", SpotifyId = " 4o3RJndRhHxkieQzQGhmbw", ReleaseDate = Convert.ToDateTime("10/2/2006 12:00:00 AM"), AlbumCoverId = 78 });
            context.Albums.Add(new Album { ArtistId = 48, Name = "Day & Age", SpotifyId = " 7FuhgOwoael0fsg9zjZxog", ReleaseDate = Convert.ToDateTime("1/1/2008 12:00:00 AM"), AlbumCoverId = 80 });
            context.Albums.Add(new Album { ArtistId = 49, Name = "Immortalized", SpotifyId = " 3qFQ4XNQ15alZrAaj5oGJK", ReleaseDate = Convert.ToDateTime("8/21/2015 12:00:00 AM"), AlbumCoverId = 81 });
            context.Albums.Add(new Album { ArtistId = 50, Name = "Twin Forks", SpotifyId = " 0cYBxtmLvhPfswriLL3um2", ReleaseDate = Convert.ToDateTime("2/25/2014 12:00:00 AM"), AlbumCoverId = 82 });
            context.Albums.Add(new Album { ArtistId = 51, Name = "Chaos And The Calm", SpotifyId = " 5BxvswQSGWrBbVCdx6mFGO", ReleaseDate = Convert.ToDateTime("12/15/2014 12:00:00 AM"), AlbumCoverId = 83 });
            context.Albums.Add(new Album { ArtistId = 52, Name = "Vision", SpotifyId = " 7c9MUVV44xJd14HgW0PVYm", ReleaseDate = Convert.ToDateTime("5/12/2015 12:00:00 AM"), AlbumCoverId = 84 });
            context.Albums.Add(new Album { ArtistId = 53, Name = "Sweeter", SpotifyId = " 2zVRgW8bXd7ukXRZSWw81j", ReleaseDate = Convert.ToDateTime("9/16/2011 12:00:00 AM"), AlbumCoverId = 86 });
            context.Albums.Add(new Album { ArtistId = 54, Name = "Saosin", SpotifyId = " 2osTPStH5H7i4fMHS7eauR", ReleaseDate = Convert.ToDateTime("9/26/2006 12:00:00 AM"), AlbumCoverId = 88 });
            context.Albums.Add(new Album { ArtistId = 55, Name = "Two Birds EP", SpotifyId = " 76gPuKkCjZbBXKS9nfWL6Y", ReleaseDate = Convert.ToDateTime("8/26/2013 12:00:00 AM"), AlbumCoverId = 89 });
            context.Albums.Add(new Album { ArtistId = 56, Name = "Storybook", SpotifyId = " 6nsOTGBDZZcb0xP1z4NuTV", ReleaseDate = Convert.ToDateTime("3/30/2014 12:00:00 AM"), AlbumCoverId = 90 });
            context.Albums.Add(new Album { ArtistId = 57, Name = "Truman", SpotifyId = " 0KJQ4tvWWp04IMvFGHNSAn", ReleaseDate = Convert.ToDateTime("7/20/2012 12:00:00 AM"), AlbumCoverId = 91 });
            context.Albums.Add(new Album { ArtistId = 58, Name = "B-Sides It's Dark Outside", SpotifyId = " 222HutTUce1KlGv3qSnwTI", ReleaseDate = Convert.ToDateTime("1/1/2006 12:00:00 AM"), AlbumCoverId = 92 });
            context.Albums.Add(new Album { ArtistId = 59, Name = "The Cowards Choir", SpotifyId = " 2AdNq7duQAXz1Jriimwx9G", ReleaseDate = Convert.ToDateTime("7/1/2009 12:00:00 AM"), AlbumCoverId = 93 });
            context.Albums.Add(new Album { ArtistId = 60, Name = "Muchacho de Lujo [Deluxe Edition]", SpotifyId = " 5MjoNQ2MOoFZFTTYNlT5x2", ReleaseDate = Convert.ToDateTime("10/25/2013 12:00:00 AM"), AlbumCoverId = 94 });
            context.Albums.Add(new Album { ArtistId = 61, Name = "Habits Of My Heart EP", SpotifyId = " 7c4oC2FhDzwu7XU7XRB4lZ", ReleaseDate = Convert.ToDateTime("9/28/2014 12:00:00 AM"), AlbumCoverId = 95 });
            context.Albums.Add(new Album { ArtistId = 62, Name = "Aware", SpotifyId = " 7f9GLwM6FgxoyehG3XT3lq", ReleaseDate = Convert.ToDateTime("11/12/2013 12:00:00 AM"), AlbumCoverId = 96 });
            context.Albums.Add(new Album { ArtistId = 63, Name = "Little Giant", SpotifyId = " 7fqZrcQ53NpZugjmXHtLK3", ReleaseDate = Convert.ToDateTime("10/6/2014 12:00:00 AM"), AlbumCoverId = 97 });
            context.Albums.Add(new Album { ArtistId = 64, Name = "Metrics of Affection", SpotifyId = " 334Uk4L4aNU8d1yjVu9Vmz", ReleaseDate = Convert.ToDateTime("7/23/2013 12:00:00 AM"), AlbumCoverId = 98 });

            // Tracks
            context.Tracks.Add(new Track { TrackId = 0, ArtistId = 0, AlbumId = 0, Name = "Gavin James", SpotifyId = "25tMQOrIU4LlUo6Sv8v5SE" });
            context.Tracks.Add(new Track { TrackId = 1, ArtistId = 1, AlbumId = 1, Name = "Zac Brown Band", SpotifyId = "6yJCxee7QumYr820xdIsjo" });
            context.Tracks.Add(new Track { TrackId = 2, ArtistId = 2, AlbumId = 2, Name = "Josh Ritter", SpotifyId = "6igfLpd8s6DBBAuwebRUuo" });
            context.Tracks.Add(new Track { TrackId = 3, ArtistId = 3, AlbumId = 3, Name = "Damien Rice", SpotifyId = "14r9dR01KeBLFfylVSKCZQ" });
            context.Tracks.Add(new Track { TrackId = 4, ArtistId = 4, AlbumId = 4, Name = "Bear's Den", SpotifyId = "0nJaMZM8paoA5HEUTUXPqi" });
            context.Tracks.Add(new Track { TrackId = 5, ArtistId = 5, AlbumId = 5, Name = "Passenger", SpotifyId = "0gadJ2b9A4SKsB1RFkBb66" });
            context.Tracks.Add(new Track { TrackId = 7, ArtistId = 6, AlbumId = 6, Name = "Ray LaMontagne", SpotifyId = "6DoH7ywD5BcQvjloe9OcIj" });
            context.Tracks.Add(new Track { TrackId = 8, ArtistId = 7, AlbumId = 7, Name = "Muse", SpotifyId = "12Chz98pHFMPJEknJQMWvI" });
            context.Tracks.Add(new Track { TrackId = 9, ArtistId = 8, AlbumId = 8, Name = "Defeater", SpotifyId = "1L3hqVCHSL1Ajy3m0z1bAT" });
            context.Tracks.Add(new Track { TrackId = 10, ArtistId = 9, AlbumId = 9, Name = "The Downtown Fiction", SpotifyId = "7MRDkEKtdsGcYn11A4qgUL" });
            context.Tracks.Add(new Track { TrackId = 11, ArtistId = 5, AlbumId = 10, Name = "Passenger", SpotifyId = "0gadJ2b9A4SKsB1RFkBb66" });
            context.Tracks.Add(new Track { TrackId = 12, ArtistId = 10, AlbumId = 11, Name = "Ben Howard", SpotifyId = "5schNIzWdI9gJ1QRK8SBnc" });
            context.Tracks.Add(new Track { TrackId = 14, ArtistId = 11, AlbumId = 12, Name = "Bon Iver", SpotifyId = "4LEiUm1SRbFMgfqnQTwUbQ" });
            context.Tracks.Add(new Track { TrackId = 15, ArtistId = 12, AlbumId = 13, Name = "Ed Sheeran", SpotifyId = "6eUKZXaKkcviH0Ku9w2n3V" });
            context.Tracks.Add(new Track { TrackId = 16, ArtistId = 13, AlbumId = 14, Name = "James Vincent McMorrow", SpotifyId = "7FDlvgcodNfC0IBdWevl4u" });
            context.Tracks.Add(new Track { TrackId = 18, ArtistId = 14, AlbumId = 15, Name = "Stu Larsen", SpotifyId = "44M8i4BCwuBbmcQWwMaOfH" });
            context.Tracks.Add(new Track { TrackId = 19, ArtistId = 15, AlbumId = 16, Name = "The Civil Wars", SpotifyId = "6J7rw7NELJUCThPbAfyLIE" });
            context.Tracks.Add(new Track { TrackId = 21, ArtistId = 16, AlbumId = 17, Name = "Hozier", SpotifyId = "2FXC3k01G6Gw61bmprjgqS" });
            context.Tracks.Add(new Track { TrackId = 22, ArtistId = 17, AlbumId = 18, Name = "Hoobastank", SpotifyId = "2MqhkhX4npxDZ62ObR5ELO" });
            context.Tracks.Add(new Track { TrackId = 23, ArtistId = 7, AlbumId = 19, Name = "Muse", SpotifyId = "12Chz98pHFMPJEknJQMWvI" });
            context.Tracks.Add(new Track { TrackId = 24, ArtistId = 18, AlbumId = 20, Name = "Ben Folds Five", SpotifyId = "44gRHbEm4Uqa0ykW0rDTNk" });
            context.Tracks.Add(new Track { TrackId = 25, ArtistId = 19, AlbumId = 21, Name = "The Verve Pipe", SpotifyId = "242iqFnwNhlidVBMI9GYKp" });
            context.Tracks.Add(new Track { TrackId = 26, ArtistId = 20, AlbumId = 22, Name = "The Smashing Pumpkins", SpotifyId = "40Yq4vzPs9VNUrIBG5Jr2i" });
            context.Tracks.Add(new Track { TrackId = 27, ArtistId = 21, AlbumId = 23, Name = "Red Hot Chili Peppers", SpotifyId = "0L8ExT028jH3ddEcZwqJJ5" });
            context.Tracks.Add(new Track { TrackId = 28, ArtistId = 22, AlbumId = 24, Name = "Rise Against", SpotifyId = "6Wr3hh341P84m3EI8qdn9O" });
            context.Tracks.Add(new Track { TrackId = 29, ArtistId = 23, AlbumId = 25, Name = "BØRNS", SpotifyId = "1KP6TWI40m7p3QBTU6u2xo" });
            context.Tracks.Add(new Track { TrackId = 30, ArtistId = 24, AlbumId = 26, Name = "Queensrÿche", SpotifyId = "2OgUPVlWYgGBGMefZgGvCO" });
            context.Tracks.Add(new Track { TrackId = 31, ArtistId = 25, AlbumId = 27, Name = "Five For Fighting", SpotifyId = "7FgMLbnZVrEnir95O0YujA" });
            context.Tracks.Add(new Track { TrackId = 32, ArtistId = 26, AlbumId = 28, Name = "Years & Years", SpotifyId = "5vBSrE1xujD2FXYRarbAXc" });
            context.Tracks.Add(new Track { TrackId = 34, ArtistId = 27, AlbumId = 29, Name = "The Temptations", SpotifyId = "3RwQ26hR2tJtA8F9p2n7jG" });
            context.Tracks.Add(new Track { TrackId = 35, ArtistId = 26, AlbumId = 30, Name = "Years & Years", SpotifyId = "5vBSrE1xujD2FXYRarbAXc" });
            context.Tracks.Add(new Track { TrackId = 36, ArtistId = 12, AlbumId = 13, Name = "Ed Sheeran", SpotifyId = "6eUKZXaKkcviH0Ku9w2n3V" });
            context.Tracks.Add(new Track { TrackId = 37, ArtistId = 12, AlbumId = 31, Name = "Ed Sheeran", SpotifyId = "6eUKZXaKkcviH0Ku9w2n3V" });
            context.Tracks.Add(new Track { TrackId = 38, ArtistId = 12, AlbumId = 31, Name = "Ed Sheeran", SpotifyId = "6eUKZXaKkcviH0Ku9w2n3V" });
            context.Tracks.Add(new Track { TrackId = 39, ArtistId = 12, AlbumId = 31, Name = "Ed Sheeran", SpotifyId = "6eUKZXaKkcviH0Ku9w2n3V" });
            context.Tracks.Add(new Track { TrackId = 40, ArtistId = 5, AlbumId = 5, Name = "Passenger", SpotifyId = "0gadJ2b9A4SKsB1RFkBb66" });
            context.Tracks.Add(new Track { TrackId = 41, ArtistId = 5, AlbumId = 5, Name = "Passenger", SpotifyId = "0gadJ2b9A4SKsB1RFkBb66" });
            context.Tracks.Add(new Track { TrackId = 42, ArtistId = 5, AlbumId = 10, Name = "Passenger", SpotifyId = "0gadJ2b9A4SKsB1RFkBb66" });
            context.Tracks.Add(new Track { TrackId = 43, ArtistId = 4, AlbumId = 32, Name = "Bear's Den", SpotifyId = "0nJaMZM8paoA5HEUTUXPqi" });
            context.Tracks.Add(new Track { TrackId = 45, ArtistId = 28, AlbumId = 33, Name = "Brett Dennen", SpotifyId = "0FC1LIeQXKib0jOwZqeIwT" });
            context.Tracks.Add(new Track { TrackId = 50, ArtistId = 29, AlbumId = 34, Name = "Joel Brown", SpotifyId = "6vMmqaauubP4qBujCf6DPY" });
            context.Tracks.Add(new Track { TrackId = 51, ArtistId = 29, AlbumId = 34, Name = "Joel Brown", SpotifyId = "6vMmqaauubP4qBujCf6DPY" });
            context.Tracks.Add(new Track { TrackId = 52, ArtistId = 30, AlbumId = 35, Name = "Nick Mulvey", SpotifyId = "3x8FbPjh2Qz55XMdE2Yalj" });
            context.Tracks.Add(new Track { TrackId = 53, ArtistId = 31, AlbumId = 36, Name = "Radiohead", SpotifyId = "4Z8W4fKeB5YxbusRsdQVPb" });
            context.Tracks.Add(new Track { TrackId = 54, ArtistId = 14, AlbumId = 15, Name = "Stu Larsen", SpotifyId = "44M8i4BCwuBbmcQWwMaOfH" });
            context.Tracks.Add(new Track { TrackId = 55, ArtistId = 32, AlbumId = 37, Name = "Sufjan Stevens", SpotifyId = "4MXUO7sVCaFgFjoTI5ox5c" });
            context.Tracks.Add(new Track { TrackId = 56, ArtistId = 32, AlbumId = 38, Name = "Sufjan Stevens", SpotifyId = "4MXUO7sVCaFgFjoTI5ox5c" });
            context.Tracks.Add(new Track { TrackId = 57, ArtistId = 33, AlbumId = 39, Name = "The Avett Brothers", SpotifyId = "196lKsA13K3keVXMDFK66q" });
            context.Tracks.Add(new Track { TrackId = 58, ArtistId = 33, AlbumId = 40, Name = "The Avett Brothers", SpotifyId = "196lKsA13K3keVXMDFK66q" });
            context.Tracks.Add(new Track { TrackId = 59, ArtistId = 34, AlbumId = 41, Name = "Jamie Lawson", SpotifyId = "1jhdZdzOd4TJLAHqQdkUND" });
            context.Tracks.Add(new Track { TrackId = 60, ArtistId = 35, AlbumId = 42, Name = "Matt Corby", SpotifyId = "7CIW23FQUXPc1zebnO1TDG" });
            context.Tracks.Add(new Track { TrackId = 61, ArtistId = 35, AlbumId = 43, Name = "Matt Corby", SpotifyId = "7CIW23FQUXPc1zebnO1TDG" });
            context.Tracks.Add(new Track { TrackId = 62, ArtistId = 35, AlbumId = 43, Name = "Matt Corby", SpotifyId = "7CIW23FQUXPc1zebnO1TDG" });
            context.Tracks.Add(new Track { TrackId = 63, ArtistId = 36, AlbumId = 44, Name = "Damien Leith", SpotifyId = "5XVcYaeSTGZXwxd63aY9Tv" });
            context.Tracks.Add(new Track { TrackId = 64, ArtistId = 37, AlbumId = 45, Name = "Hudson Taylor", SpotifyId = "4DX2G1URzfEiRg2wBfv4ub" });
            context.Tracks.Add(new Track { TrackId = 65, ArtistId = 38, AlbumId = 46, Name = "Zach Hurd", SpotifyId = "1f2CFEq5J7ZyeTAVU6ubRX" });
            context.Tracks.Add(new Track { TrackId = 66, ArtistId = 39, AlbumId = 47, Name = "Brandon Flowers", SpotifyId = "18Zv2g2vUcEGqJf6WnjfXN" });
            context.Tracks.Add(new Track { TrackId = 67, ArtistId = 40, AlbumId = 48, Name = "Nick Jonas", SpotifyId = "4Rxn7Im3LGfyRkY2FlHhWi" });
            context.Tracks.Add(new Track { TrackId = 68, ArtistId = 40, AlbumId = 49, Name = "Nick Jonas", SpotifyId = "4Rxn7Im3LGfyRkY2FlHhWi" });
            context.Tracks.Add(new Track { TrackId = 69, ArtistId = 41, AlbumId = 50, Name = "A Great Big World", SpotifyId = "5xKp3UyavIBUsGy3DQdXeF" });
            context.Tracks.Add(new Track { TrackId = 70, ArtistId = 42, AlbumId = 51, Name = "Penny and Sparrow", SpotifyId = "65o6y7GtoXzchyiJB3r9Ur" });
            context.Tracks.Add(new Track { TrackId = 71, ArtistId = 43, AlbumId = 52, Name = "Anthony D'Amato", SpotifyId = "1oplL2hHYq7CQykvSbd6gy" });
            context.Tracks.Add(new Track { TrackId = 72, ArtistId = 44, AlbumId = 53, Name = "Landon Pigg", SpotifyId = "1whjlG0NSaQytgDIWz10GS" });
            context.Tracks.Add(new Track { TrackId = 73, ArtistId = 45, AlbumId = 54, Name = "Joshua Hyslop", SpotifyId = "1I7oHjCjMrMUz66v67yJJu" });
            context.Tracks.Add(new Track { TrackId = 74, ArtistId = 46, AlbumId = 55, Name = "The Boxer Rebellion", SpotifyId = "7DEseTqRODmSu3C7jxCHl5" });
            context.Tracks.Add(new Track { TrackId = 75, ArtistId = 47, AlbumId = 56, Name = "The Dangerous Summer", SpotifyId = "0iMnpaEHXkgMT956CmP1kj" });
            context.Tracks.Add(new Track { TrackId = 76, ArtistId = 48, AlbumId = 57, Name = "The Killers", SpotifyId = "0C0XlULifJtAgn6ZNCW2eu" });
            context.Tracks.Add(new Track { TrackId = 77, ArtistId = 48, AlbumId = 57, Name = "The Killers", SpotifyId = "0C0XlULifJtAgn6ZNCW2eu" });
            context.Tracks.Add(new Track { TrackId = 78, ArtistId = 48, AlbumId = 58, Name = "The Killers", SpotifyId = "0C0XlULifJtAgn6ZNCW2eu" });
            context.Tracks.Add(new Track { TrackId = 79, ArtistId = 48, AlbumId = 57, Name = "The Killers", SpotifyId = "0C0XlULifJtAgn6ZNCW2eu" });
            context.Tracks.Add(new Track { TrackId = 80, ArtistId = 48, AlbumId = 59, Name = "The Killers", SpotifyId = "0C0XlULifJtAgn6ZNCW2eu" });
            context.Tracks.Add(new Track { TrackId = 81, ArtistId = 49, AlbumId = 60, Name = "Disturbed", SpotifyId = "3TOqt5oJwL9BE2NG9MEwDa" });
            context.Tracks.Add(new Track { TrackId = 82, ArtistId = 50, AlbumId = 61, Name = "Twin Forks", SpotifyId = "6GwNGuDRNbx5XwoHQA3QiD" });
            context.Tracks.Add(new Track { TrackId = 83, ArtistId = 51, AlbumId = 62, Name = "James Bay", SpotifyId = "4EzkuveR9pLvDVFNx6foYD" });
            context.Tracks.Add(new Track { TrackId = 84, ArtistId = 52, AlbumId = 63, Name = "Jeff LeBlanc", SpotifyId = "0F55dmw0A9gnYhgJfH0b3b" });
            context.Tracks.Add(new Track { TrackId = 85, ArtistId = 26, AlbumId = 30, Name = "Years & Years", SpotifyId = "5vBSrE1xujD2FXYRarbAXc" });
            context.Tracks.Add(new Track { TrackId = 86, ArtistId = 53, AlbumId = 64, Name = "Gavin DeGraw", SpotifyId = "5DYAABs8rkY9VhwtENoQCz" });
            context.Tracks.Add(new Track { TrackId = 88, ArtistId = 54, AlbumId = 65, Name = "Saosin", SpotifyId = "1NUOfvAhA9AvsF1ISMkgHX" });
            context.Tracks.Add(new Track { TrackId = 89, ArtistId = 55, AlbumId = 66, Name = "Richard Walters", SpotifyId = "3rUqgY188kWz0hKkqnpk9F" });
            context.Tracks.Add(new Track { TrackId = 90, ArtistId = 56, AlbumId = 67, Name = "Skinny Living", SpotifyId = "405DvLr0FOuOWYgCt0emff" });
            context.Tracks.Add(new Track { TrackId = 91, ArtistId = 57, AlbumId = 68, Name = "The Midwest Indies", SpotifyId = "2knI8PaBy2UyrRBhGmBbQJ" });
            context.Tracks.Add(new Track { TrackId = 92, ArtistId = 58, AlbumId = 69, Name = "Joshua James", SpotifyId = "0YLUOdFiedWIWBttlDAQeO" });
            context.Tracks.Add(new Track { TrackId = 93, ArtistId = 59, AlbumId = 70, Name = "Andy Zipf", SpotifyId = "5gj2Ul170gSipbsNQbea37" });
            context.Tracks.Add(new Track { TrackId = 94, ArtistId = 60, AlbumId = 71, Name = "Phosphorescent", SpotifyId = "57kIMCLPgkzQlXjblX7XXP" });
            context.Tracks.Add(new Track { TrackId = 95, ArtistId = 61, AlbumId = 72, Name = "Jaymes Young", SpotifyId = "6QrQ7OrISRYIfS5mtacaw2" });
            context.Tracks.Add(new Track { TrackId = 96, ArtistId = 62, AlbumId = 73, Name = "Front Porch Step", SpotifyId = "4UXiNDHAiv8DOSLkp0GbSm" });
            context.Tracks.Add(new Track { TrackId = 97, ArtistId = 63, AlbumId = 74, Name = "Roo Panes", SpotifyId = "0XHM5ZNJDU8e4CfbWMeSzC" });
            context.Tracks.Add(new Track { TrackId = 98, ArtistId = 64, AlbumId = 75, Name = "Bombadil", SpotifyId = "6AlXfeCNG9lrauBDG7GyjM" });
            context.Tracks.Add(new Track { TrackId = 99, ArtistId = 62, AlbumId = 73, Name = "Front Porch Step", SpotifyId = "4UXiNDHAiv8DOSLkp0GbSm" });
