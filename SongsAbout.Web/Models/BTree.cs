...
namespace SongsAbout.Web.Models
{
    ...
    public class BTree<TK, TP> where TK : IComparable<TK>
    {
        ...
        public Entry<TK, TP> SearchExact(TK key)
        {
            return this.SearchExactInternal(this.Root, key);
        }
        ...
        private Entry<TK, TP> SearchExactInternal(Node<TK, TP> node, TK key)
        {
            ...
            return node.IsLeaf ? null : this.SearchExactInternal(node.Children[i], key);
        }
