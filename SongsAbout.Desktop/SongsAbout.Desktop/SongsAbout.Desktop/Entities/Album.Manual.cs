...
namespace SongsAbout.Desktop.Entities
{
    ...
    public partial class Album : DbEntity
    {
        ...
        public SpotifyImage AlbumCover { get; set; }
        ...
        public override void Save()
        {
            try
            {
                string imageLine = $@"var {this.name}_img = new AlbumCover {{AlbumCoverId = {DB_SEED_ID}, Url = {this.AlbumCover.Url}, Width = {this.AlbumCover.Width}, Height = {this.AlbumCover.Height} }} ";
                string albumLine = $@"var {this.name} = new Artist {{ArtistId = {DB_SEED_ID},AlbumCoverId = {DB_SEED_ID}, Name = {this.name},ReleaseDate = {this.ReleaseDate}, SpotifyId = {this.al_spotify_uri} }};";

                base.SaveEntitySeed($@"
                            {imageLine}
                            {albumLine}
                            context.AlbumCovers.Add({this.name}_img);
                            context.Album.Add({this.name});");
                DB_SEED_ID++;
